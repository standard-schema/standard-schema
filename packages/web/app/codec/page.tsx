...
export async function generateMetadata() {
  const title = "Standard Codec";
  const description = "A common interface for bidirectional transformations";
  const url = getUrl();
  return {
    title,
    description,
...
export default async function CodecPage() {
  const mdPath = join(process.cwd(), "..", "spec", "codec.md");
