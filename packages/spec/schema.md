...
| [standard-tool](https://github.com/finom/standard-tool)                       | One interface for an LLM tool: name, description, Standard Schema input/output, and `execute`                                         | [Docs](https://standard-tool.js.org)                                                                  |
