...
| [RTK Query](https://redux-toolkit.js.org/rtk-query/overview)          | A powerful data fetching and caching tool, included with Redux Toolkit.                                                                                                                         | [Docs](https://deploy-preview-4926--redux-starter-kit-docs.netlify.app/rtk-query/usage-with-typescript#schema-validation) |
